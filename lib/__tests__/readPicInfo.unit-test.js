...
const RBUAS20150310 = resourceFile('RBUAS20150310-0052.jpg');
const RBUAS20160727 = resourceFile('RBUAS20160727-0414-1.jpg');
const RBUAS20161022 = resourceFile('RBUAS20161022-0034.jpg');
const RBUAS20180601DNG = resourceFile('RBUAS20180601-0025.dng');
const RBUAS20180601FULL = resourceFile('RBUAS20180601-0025.full.jpg');
const RBUAS20180601MOBILE = resourceFile('RBUAS20180601-0025.mobile.jpg');
...
describe('readPicInfo', () => {
  ...
  it('should read a file info from RBUAS20180601DNG', async () => {
    ...
    expect(info).toMatchObject({
      ...
      Rating: 4,
      Label: 'Blue',
      Keywords: ['Lausanne', 'Suisse', 'classique', 'danse', 'igokat', 'le carnaval des animaux', 'rbuas'],
    });
  });
