...
describe('generatePicInfo', () => {
  it('should generate a file containing the pic info', async () => {
    ...
    expect(info).toMatchObject({
      ...
      Filetype: 'jpg',
      Filepath: '/Users/az02191-dev/dev/image-room/lib/info/__tests__/resources',
      SourceFile: '/Users/az02191-dev/dev/image-room/lib/info/__tests__/resources/RBUAS20150310-0052.jpg',
      Format: 'image/jpeg',
